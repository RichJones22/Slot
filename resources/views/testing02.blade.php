...
<div class="container">
    <div class="row">
        <form>
            ...
            <div hidden class="dialogMessage col-md-2 col-sm-2 col-xs-6" id="dialogMessageId" tabindex="3">
                <div>
                    <input class="project-dialog form-control" type="text" id="projectDialogId" placeholder="Project">
                </div>
                <div style="width: 300px;">
                    <input class="project-dialog form-control" type="checkbox" placeholder="from database">
                </div>
